...
const countriesEndsByia = countries7.filter((country) => country.endsWith('nd'))
console.log("Ejemplo 7: Paises que terminan en i")
console.log(countriesEndsByia)


const countriesStartDe = countries7.filter((country) => country.toLowerCase().startsWith('fi'))
console.log("Ejemplo 7: Paises que terminan en i")
console.log(countriesStartDe)